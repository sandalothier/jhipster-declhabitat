...
import com.fisc.declhabitat.DeclhabitatApp;
...
@SpringBootTest(classes = DeclhabitatApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DeclhabitatKafkaResourceIT {
    ...
    @Autowired
    private DeclhabitatKafkaProducer producer;

    @Autowired
    private DeclhabitatKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclhabitatKafkaResource kafkaResource = new DeclhabitatKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declhabitat-kafka/publish?message=test"))
